...
/**
 * Desc: Print a timestamp from the local time. This function should be used
 * 		 With care as the localtime function used on POSIX systems is not
 * 		 thread-safe (for compatibility with older C standards)
**/
void PrintTimeStamp();
