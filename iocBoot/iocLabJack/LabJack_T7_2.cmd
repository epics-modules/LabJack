...
drvAsynIPPortConfigure("LJT7_$(N)","192.168.100.31:502",0,0,1)
...
# Digital Inputs
dbLoadRecords("$(TOP)/xyzApp/Db/LabJack_T7_di.db", "P=$(P)LJT7:$(N):")

# Analog Inputs SE/Diff select
dbLoadRecords("$(TOP)/xyzApp/Db/LabJack_T7_seDiff.db", "P=$(P)LJT7:$(N):")
